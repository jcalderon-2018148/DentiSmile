...
public class Cita {
    ...
    public Cita(int codigoCita, Date fechaCita, java.sql.Time horaCita, String tratamiento, String descripCondActual, int codigoPaciente, int numeroColegiado) {
    ...
    public void setHoraCita(java.sql.Time horaCita) {
        this.horaCita = horaCita;
    }
